...
tags:
  - gamedev
---
![Cover](AAA_Meta/attachments/gemz/cover.png)
...
![Procedural Mace Generation](AAA_Meta/attachments/gemz/mace_generation.gif)

### Pathfinding
The enemy AIs pathfinding is based on the [A* Pathfinding Project](https://arongranberg.com/astar/) by Aron Granberg.

![Enemy AI Pathfinding](AAA_Meta/attachments/gemz/enemy_ai.gif)
